  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to MyBlog, your personal webpage builder with a simple integrated blog. Manage your home-page, blog items, and contacts form effortlessly through our user-friendly GUI."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1530435460869-d13625c69bbf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx3ZWJwYWdlfGVufDB8fHx8MTY5NTM5NjE4MHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@pankajpatel?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Pankaj Patel`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to MyBlog, your personal webpage builder with a simple integrated blog. Manage your home-page, blog items, and contacts form effortlessly through our user-friendly GUI.`}
            </Text>
            <Box
